...
import { IReportLoanService } from '../../services/ireportloan.service';
declare var $: any;
@Component({
  selector: 'app-loanreport',
  templateUrl: './loanreport.component.html',
  styleUrl: './loanreport.component.css'
})
export class LoanreportComponent {
  ...
  constructor(
    ...
    private ireportloanService: IReportLoanService,
  ...
  getLoanReport() {
    if (this.reportParms.rp_report_type != "") {
      ...
      this.ireportloanService.getLoanReport(this.reportParms).subscribe(
        (data: any[]) => {
